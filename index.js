...
document.getElementById("contactBtn").addEventListener("click",function(){
    ...
    link.href = "/CV-2K23_final.pdf";
    link.download = "Leopold-van-der-Elst-CV.pdf";
    link.click();
})


document.getElementById("projectImg1").addEventListener('mouseover', (event) => {
...
document.getElementById("projectImg2").addEventListener('mouseover', (event) => {
...
document.getElementById("projectImg3").addEventListener('mouseover', (event) => {
